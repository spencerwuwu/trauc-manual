...
chmod 666 -R trace/
sshpass -p deploy scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r trace deploy@10.32.0.210:/home/deploy/traces/${TARGET}.${DATE}.${BENCHMARK_TARGET}
